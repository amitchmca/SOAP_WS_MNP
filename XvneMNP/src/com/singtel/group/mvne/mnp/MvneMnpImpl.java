...
public class MvneMnpImpl {
	...
	XvneNPOTResponse populateXvneNPOT() throws MvneMnpException{
...
Result populateNPOTResult()  throws MvneMnpException {
	...
	PortDetails populateNPOT() throws MvneMnpException {
	 ...
	 XvneSDResponse populateXvneSD() throws MvneMnpException{
	...
	Result populateSDResult()  throws MvneMnpException {
	...
	PortDetails populateSD() throws MvneMnpException {
		PortDetails npo = new PortDetails();
	...
	XvneNPOResponse populateXvneNPOC() throws MvneMnpException {
	...
	PortDetails populateNPO() throws MvneMnpException {
		PortDetails npo = new PortDetails();
	...
	SubscriberSequence populateSubSeq()  throws MvneMnpException {
		SubscriberSequence subscriberSequence = new SubscriberSequence();
		String[] subSeq = new String[] {"6597990809"};		
	...
	Customer populateCustomer() throws MvneMnpException {
	...
	MVNO populateMVNO() throws MvneMnpException {
	...
	Params populateParams()  throws MvneMnpException {
	...
	/*	List<Param> paramlist= new ArrayList<Param>();			
		...
		Params params=new Params();
		//Param[] paramArray = new Param[2];
		Param[] paramArray = new Param[] {new Param("Param1", "Valu1e"),new Param("Param2", "Value2")};
		...
		params.setParams(paramArray);
		return params;
		
	}
	
	Result populateResult()  throws MvneMnpException {
	...
	Error populateError()  throws MvneMnpException {
