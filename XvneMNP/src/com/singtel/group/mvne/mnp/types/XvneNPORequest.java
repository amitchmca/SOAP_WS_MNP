...
public class XvneNPORequest {
	...
	public XvneNPORequest(PortDetails portDetails, MVNO mvno, SubscriberSequence subscriberSequence, Customer customer, Params params) {
		super();
	...
	public void setNpo(PortDetails portDetails) {
		this.portDetails = portDetails;
	}
