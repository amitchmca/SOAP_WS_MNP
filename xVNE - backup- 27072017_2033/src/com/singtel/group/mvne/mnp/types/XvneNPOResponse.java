...
@XmlType(propOrder= {"npo", "mvno",  "subscriberSequence", "customer", "params", "result", "error" })
...
*/
	...
	public XvneNPOResponse(NPO npo, SubscriberSequence subscriberSequence, Customer customer, MVNO mvno, Params params,
